...
export const app_info = {
  title: "APSOD - Digital маркетинг и SEO продвижение",

  description: "Профессиональное продвижение сайтов, 
SEO-оптимизация, контекстная реклама. Увеличиваем трафик и 
конверсии для вашего бизнеса.",
} as const; //
