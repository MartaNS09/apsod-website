...
export const app_info = {
  title: "APSOD - Профессиональное SEO",
  description: "Профессиональное продвижение сайтов,SEO-оптимизация, контекстная реклама. Увеличиваем трафик и конверсии для вашего бизнеса.",} as const //
